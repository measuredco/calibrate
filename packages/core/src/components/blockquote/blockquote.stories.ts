...
export const Default = {
  args: {
    align: "start",
    attribution: `<a href="http://www.germandesigners.net/designers/hans_peter_schmoller">Hans P. Schmoller</a>, in <i>Book Design Today</i>, Printing Review, Spring 1951`,
    measured: true,
    quote:
